...
export const APP_JSON = 'app/all_courses_updated_one_week_schedule_occ_separated.json';
...
// drift — and run.mjs calls this right after ensureClone, so origin/<branch>
